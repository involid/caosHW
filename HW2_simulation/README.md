0. Реализуйте функцию с прототипом:
...
1. Реализуйте функцию с прототипом:
...
2. Реализуйте функцию с прототипом:
...
3. Реализуйте калькулятор выражений над множествами в обратной польской записи.
...
4. На стандартном потоке ввода подается последовательность символов в кодировке UTF-8.
